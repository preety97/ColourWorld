...
public class ToolcatActivity extends AppCompatActivity {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toolcat);
       ...
       // TextView textViewAddToCart = findViewById(R.id.text_action_bottom1);
        ...
        ttype = intent.getStringExtra("tool");
        ...
        textView.setText(intent.getStringExtra("tool"));
        ...
        textViewAddToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ToolcatActivity.this,"Item added to cart.",Toast.LENGTH_SHORT).show();
        ...
        final Intent intents = new Intent(ToolcatActivity.this,HomeActivity.class);
